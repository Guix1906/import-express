...
-- Minimal safe documents table. No DO, IF, EXECUTE, or foreign keys.
...
CREATE INDEX IF NOT EXISTS idx_documents_triagem ON public.documents(company_id, triagem_id);
